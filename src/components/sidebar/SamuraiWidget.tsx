      ...
      <svg width="100%" viewBox="0 0 160 240" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <style>{`
            ...
            .qq1 { animation: q1 10s ease-in-out infinite; }
            .qq2 { animation: q2 10s ease-in-out infinite; }
            .qq3 { animation: q3 10s ease-in-out infinite; }
            .qq4 { animation: q4 10s ease-in-out infinite; }
          `}</style>
        </defs>
        ...
        <g className="qq3">
          <text x="80" y="178" textAnchor="middle" fontFamily="sans-serif" fontSize="9" fill="#9F7AEA">"Ahorra hoy, domina mañana"</text>
        </g>
        <g className="qq4">
          <text x="80" y="175" textAnchor="middle" fontFamily="sans-serif" fontSize="8" fill="#9F7AEA">"El guerrero planifica</text>
          <text x="80" y="186" textAnchor="middle" fontFamily="sans-serif" fontSize="8" fill="#9F7AEA">antes de gastar"</text>
        </g>

        <text x="80" y="200" textAnchor="middle" fontFamily="sans-serif" fontSize="8" fill="#4C1D95">武士道 · Bushido</text>
        <rect x="8" y="208" width="144" height="0.5" fill="#4C1D95" opacity="0.4"/>
