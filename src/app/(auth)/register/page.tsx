...
import { Loader2, User, Mail, CheckCircle, ArrowLeft } from 'lucide-react'
...
export default function RegisterPage() {
    ...
    return (
      <div className="px-6 py-8 lg:px-0 lg:py-0">
        ...
        <div className="text-center space-y-6">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-white mb-2">¡Casi listo!</h1>
            <p className="text-gray-400">
              Te enviamos un correo a <span className="text-white font-medium">{email}</span>
            </p>
            <p className="text-sm text-gray-500 mt-3">
              Haz click en el enlace para confirmar tu cuenta y comenzar.
            </p>
          </div>

          <div className="pt-4 space-y-3">
            <p className="text-xs text-gray-500">¿No te llegó el correo?</p>
            <button
  ...
  return (
    <div className="px-6 py-8 lg:px-0 lg:py-0">
      ...
      <div className="mb-6">
        <h1 className="text-2xl lg:text-2xl font-bold tracking-tight text-white">Crea tu cuenta</h1>
